...
blog_name        = "pingswept.org: blogging since the end of time"

## blog_description -- A short one line description of the blog
# used in the RSS/Atom feeds.
blog_description = "Text representations of Brandon Stafford's thoughts on the web"
